...
const viewContent = {
  ...
  News: () => `<div class="view-header"><div><p class="eyebrow">IDIOTCORD updates</p><h2>News</h2><p>Launcher updates and Minecraft community notes.</p></div></div><div class="news-list"><article><span>${appVersion}</span><div><strong>Launcher polish</strong><p>Added the animated startup splash, clean taskbar-style mark, longer loading handoff, and newest-launcher shortcut.</p></div></article><article><span>0.1.1</span><div><strong>Authentication and updater infrastructure</strong><p>Added Microsoft login configuration, public GitHub update metadata, startup update decisions, and automated build backups.</p></div></article><article><span>0.1.0</span><div><strong>Launcher foundation</strong><p>Initial native host, WebView2 dashboard, Minecraft version discovery, and vanilla installation foundation.</p></div></article></div>`,
