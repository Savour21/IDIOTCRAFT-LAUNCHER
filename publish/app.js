...
window.setUpdateNotice = (status, version, downloadUrl, notes) => {
...
const viewContent = {
  ...
  News: '<div class="view-header"><div><p class="eyebrow">IDIOTCORD updates</p><h2>News</h2><p>Launcher updates and Minecraft community notes.</p></div></div><div class="news-list"><article><span>0.8.0</span><div><strong>Faster profile loading</strong><p>Native instance resolution is being prepared for the desktop build.</p></div></article><article><span>Next</span><div><strong>Account and mod services</strong><p>Microsoft authentication and mod catalog integration are next.</p></div></article></div>',
